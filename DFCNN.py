...
class AcousticModel(nn.Module):
    """
    4 layers of convolution and 2 layers of gru with 3 layers fully connected layers.
    """
    def __init__(self, vocab_size, input_dimension):
        ...
        self.rnn = LSTM(in_features=128, out_features=128, num_layers=4)
    ...
    def forward(self, x):
        ...
        # print(conv5.shape)
        conv4 = conv4.view(-1, conv4.shape[1], self.fc_features)
